...
public class InicializadorDaTemporada {
    ...
    private static final int LIMITE_JOGOS_POR_SEMANA = 3;
    private static final int TEMPERATURA_MAXIMA = 40;
    ...
    public static void main(String[] args) {
        ...
        try (Scanner input = new Scanner(System.in)) {
            while (jogosPorSemana < LIMITE_JOGOS_POR_SEMANA) {
                ...
                if (temperaturaDaSemana < 0 || temperaturaDaSemana > TEMPERATURA_MAXIMA) {
                    break;
                }

                if (temperaturaDaSemana <= 0) {
                    jogosPorSemana++;
                } else {
                    jogosPorSemana = 0;
